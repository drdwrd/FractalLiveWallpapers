...
public class GLES2ConfigChooser implements EGLConfigChooser
{
...
*/
    ...
    protected void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs)
	{
		int numConfigs = configs.length;
		LogSystem.debug(GLWallpaperService.tag,String.format("%d configurations", numConfigs));
		for (int i = 0; i < numConfigs; i++)
		{
			LogSystem.debug(GLWallpaperService.tag, String.format("Configuration %d:\n", i));
    ...
    protected void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config)
	{
		...
		for (int i = 0; i < attributes.length; i++)
		{
			...
			{
				LogSystem.debug(GLWallpaperService.tag, String.format(" %s: %d\n", name, value[0]));
			}
			else
			{
