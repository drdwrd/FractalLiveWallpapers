...
import drwdrd.adev.glwallpaperservice.BaseConfigChooser.ComponentSizeChooser;
import drwdrd.adev.glwallpaperservice.BaseConfigChooser.SimpleEGLConfigChooser;
...
public class GLWallpaperService extends WallpaperService
{
	...
	public static void checkEglError(String prompt, EGL10 egl)
	{
		...
		{
			LogSystem.error(GLWallpaperService.tag,String.format("%s: EGL error: 0x%x", prompt, error));
		}
	}
	...
	public class GLEngine extends Engine
	{
		...
		{
			super.onDestroy();
			//Log.d(GLWallpaperService.tag, "GLEngine.onDestroy()");
